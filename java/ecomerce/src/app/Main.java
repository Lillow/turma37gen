...
public class Main {
	...
	public static void main(String[] args) {
        ...
        //Repete todo o processo se o usuario quiser fazer outra compra
        while(true) 
        {
	        ...
	        if (opcaoPag==1) {
	        	...
	        	System.out.printf("9%% de impostos sob o produto: R$ %.2f",imposto);
	        ...
	        System.out.println("\n----------------------------------");
	        //Faz parte do while(true)
	        System.out.print("\nDeseja realizar outra compra? [1 = SIM / 2 = NAO] ");
	        continuarCompras = leitor.nextInt();
	        if (continuarCompras == 2)
	        {
