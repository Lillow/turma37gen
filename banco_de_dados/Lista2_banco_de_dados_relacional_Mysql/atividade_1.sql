...
("guerreiro","habilidades com armas"),
("mago", "maetria arcana"),
("arqueiro", "arquearia"),
...
VALUES
("Arthas", 1500, 5000, 31, 1),
("Carlos",1300, 1500, 23, 2),
("Jayna",2200, 3000, 45, 2),
("Ilidam",3000, 1100, 64, 4),
("Erik",1200, 3000, 23, 3),
("Valyra",3400, 900, 34, 4),
("Malfurion",1500, 4000, 32, 5),
("Kalmir",4000, 5000, 23, 1);
